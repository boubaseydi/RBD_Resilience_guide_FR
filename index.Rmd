...
[Chapter 3 Score/Groupes de consommation alimentaire et score de diversité alimentaire des ménages (FCS/FCG & HDDS)](https://wfp-vam.github.io/RBD_FS_CH_guide_FR/scoregroupes-de-consommation-alimentaire-et-score-de-diversit%C3%A9-alimentaire-des-m%C3%A9nages-fcsfcg-hdds.html) versions papier et électronique du questionnaire standardisé et de la syntaxe SPSS/R pour le calcul des indicateurs Score/Groupes de consommation alimentaire et Score de diversité alimentaire des ménages.
...
[Chapter 4 L’indice réduit des stratégies de survie (rCSI)](https://wfp-vam.github.io/RBD_FS_CH_guide_FR/lindice-r%C3%A9duit-des-strat%C3%A9gies-de-survie-rcsi.html) versions papier et électronique du questionnaire standardisé et de la syntaxe SPSS/R pour le calcul de l'indicateur réduit de l'indice de stratégie d'adaptation.



[Chapter 6 Stratégie d’adaption aux moyens d’existence (LHCS)](https://wfp-vam.github.io/RBD_FS_CH_guide_FR/strat%C3%A9gie-dadaption-aux-moyens-dexistence-lhcs.html) versions papier et électronique du questionnaire standardisé et de la syntaxe SPSS/R pour le calcul de la stratégie d'adaptation maximale utilisée pour la version légère CARI et la version ENA du module "Livelihood Coping Strategies".

[Chapter 7 Questionnaire combiné & Syntaxes pour les 5 indicateurs](https://wfp-vam.github.io/RBD_FS_CH_guide_FR/questionnaire-combin%C3%A9-syntaxes-pour-les-5-indicateurs.html) combine les questionnaires et les syntaxes des chapitres 4 à 7.

[Chapter 8 Rapport de contrôle de la qualité des données](https://wfp-vam.github.io/RBD_FS_CH_guide_FR/rapport-de-contr%C3%B4le-de-la-qualit%C3%A9-des-donn%C3%A9es.html) fournit des instructions et la syntaxe R pour un rapport de contrôle de la qualité des données, en utilisant des données d'enquête brutes.

[Chapter 9 Calcul de la matrice intermédiaire (preuve données directes sur la sécurité alimentaire)](https://wfp-vam.github.io/RBD_FS_CH_guide_FR/calcul-de-la-matrice-interm%C3%A9diaire-preuve-donn%C3%A9es-directes-sur-la-s%C3%A9curit%C3%A9-alimentaire.html) fournit des instructions et une syntaxe R pour produire, à partir d'un fichier spss traité, les indicateurs directs de sécurité alimentaire et les géocodes qui peuvent être copiés dans la matrice intermediare.
